...
import type { BatchEditInfraction, BatchEditLateness, EditInfraction, EditLateness, EventQueryFilters, LocalInfraction, LocalLateness, NewInfraction, NewLateness } from "~/models/types";
...
export const infractionRepo = {
    getInfractions: (filters: EventQueryFilters) => {
        ...
        const { stmt: whereStmt, bindings: whereBindings } = buildSQLClause("infraction", otherFilters)
