...
const editLatenessSchema = latenessSchema.partial().required({ id: true }) satisfies z.ZodType<EditLateness>
const batchEditLatenessSchema = editLatenessSchema.omit({ id: true }).extend({ ids: z.array(z.number()) }) satisfies z.ZodType<BatchEditLateness>
